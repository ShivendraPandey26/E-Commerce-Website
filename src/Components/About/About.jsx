    ...
    <Layout>
      <div className="bg-[#eaf5f5]">
        <div className="container h-full w-screen mx-auto p-8 text-center">
          ...
          <h2 className="text-left text-2xl font-serif font-bold text-orange-600 my-10">
            Our Story
          </h2>
          ...
          <div className="lg:flex mb-10">
            ...
            <p className="text-xl text-[#32597d] font-medium mb-9 p-5 text-start leading-relaxed">
              We believe that every home should be a reflection of the people
              who live there. That's why we offer a diverse range of products,
              from vintage furniture to modern art prints, that cater to all
              styles and budgets. Our products are carefully curated to ensure
              that they are of the highest quality and meet our customers'
              expectations.
            </p>
          </div>
